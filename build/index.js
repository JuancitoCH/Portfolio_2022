...
const knowlege_namespaceObject = __webpack_require__.p + "dd64163898f816db3794.json";
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 18;
            return formatJsonFile(knowlege_namespaceObject);
...
var knowlege_node_list = document.querySelectorAll('.knowlege_card'); // console.log(knowlege_node_list)
...
try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    ...
    known.addEventListener('click', function (e) {
      var hash_url = this.childNodes[3].textContent;
